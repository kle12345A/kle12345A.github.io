...
<!--                                                <td><input type="number" name="quantity" value="${C.value.quantity}" min="0" /></td>-->
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4">
                                        ...
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">VAT</strong><strong>0.5$</strong></li>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng thanh toán</strong>

                                            <h5 class="font-weight-bold">${totalMoney+0.5}$</h5>
                                        </li>
                                    </ul><a href="checkout" class="btn btn-success w-25">Check out</a>
                                </div>
                            </div>
                        </div>
